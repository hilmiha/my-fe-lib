    ...
    if(windowSize<=2){
        return(
            <div className="absolute top-0 left-0 w-full h-full">
                ...
                >
                    <div className="bg-base-background-top dark:bg-baseDark-background-top w-full border border-grays-300 dark:border-grays-700 max-h-[400px] overflow-y-scroll rounded-md">
                        {
                            (props.isSearchInput)&&(
        ...
        return(
            <div className="absolute top-full left-0 bg-base-background-top dark:bg-baseDark-background-top w-full border border-grays-300 dark:border-grays-700 max-h-80 overflow-y-scroll z-10 rounded-md mt-1">
                {
                    (props.isSearchInput)&&(
                        <div className="sticky top-0 pt-2 pb-1 px-1 bg-inherit">
                            <FormInput
