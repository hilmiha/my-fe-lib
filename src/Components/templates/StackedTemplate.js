...
const SidebarTemplate = (props) =>{
    ...
    return(
        <div className={(darkMode?('dark'):(''))}>
            <div className="text-grays-600 dark:text-grays-400 text-sm flex flex-col relative">
            {
                    (isSideShown)&&(
                ...
                <div className="bg-base-background-mid dark:bg-baseDark-background-mid grow min-h-screen">
                    <div className="px-4 min-h-[55px] border border-x-0 border-t-0 border-grays-300 dark:border-gray-700 bg-base-background-top dark:bg-baseDark-background-top sticky top-0 z-10 flex justify-end items-center ">
                        <div className="absolute w-screen h-full max-w-full p-4 left-0 flex items-center">
                            <div className="flex">
                                Header
                            </div>
                            {
                                windowSize>=3&&(
                                    <div className="flex max-w-full w-screen overflow-auto px-1 justify-between items-center pointer-events-auto space-x-4">
